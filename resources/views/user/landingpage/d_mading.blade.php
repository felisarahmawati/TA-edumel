@extends('layouts_user.dmading_main')
...
<div class="page-wrapper">
   ...
   <div class="single-post-content">
        ...
        <h3 class="post-title"> Digital Marketing Service Launched Ready Their Website Working Our Site.</h3>
        ...
        <h4 class="inner-title">SEO is a Cost-Effective Advertising Strategy</h4>
   ...
   <div class="blog-footer-meta d-md-flex justify-content-between align-items-center">
    ...
    <div class="post-single-author mb-5">
        <div class="author-img">
            <img src="assets/user/images/blog/author.jpg" alt="" class="img-fluid">
        </div>
