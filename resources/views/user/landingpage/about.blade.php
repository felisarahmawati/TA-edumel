@extends('layouts_user.about_main')
        ...
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="about-content mt-3 mt-lg-0">
                    ...
                    <p style="text-align: justify;">Perpustakaan didirikan sejak awal pembangunan Gedung SMKN 2 Indramayu . Setelah berpindah beberapa kali maka gedung kami yang terakhir adalah yang resmi digunakan pada tahun 2017 bertempat di Pusat belajar. Pendidikan gedung baru ini diharapkan mampu menambah minat baca warga sekolah.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-xl-6 pe-5">
                <div class="about-features">
                    <div class="feature-text">
                        <h4>Visi :</h4>
                        <p>“ Terwujud Perpustakaan Sekolah sebagai media pengembangan minat baca dan kegemaran mambaca serta pusat layanan informasi bagi Taruna/Taruni maupun warga sekolah”.</p>
                </div>
