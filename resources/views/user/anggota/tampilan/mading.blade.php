                    ...
                    <div class=" course-style-5 bg-white">
                        ...
                        <div class="course-content">
                            ...
                            <div class="course-footer mt-20 d-flex align-items-center justify-content-between">
                                ...
                                <a href="/d_mading" class="rounded-btn"><i class="fa fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="course-item col-lg-3 col-md-6 col-sm-6">
                    <div class=" course-style-5 bg-white">
                        ...
                        <div class="course-content">
                            ...
                            <div class="course-footer mt-20 d-flex align-items-center justify-content-between">
                                <span class="students"><i class="far fa-user-alt me-2"></i>Angelie Shakira Silubun</span>
                                <a href="/d_mading" class="rounded-btn"><i class="fa fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="course-item col-lg-3 col-md-6 col-sm-6">
                    <div class=" course-style-5 bg-white">
                        ...
                        <div class="course-content">
                            ...
                            <div class="course-footer mt-20 d-flex align-items-center justify-content-between">
                               <span class="students"><i class="far fa-user-alt me-2"></i>Dila</span>
                               <a href="/d_mading" class="rounded-btn"><i class="fa fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="course-item col-lg-3 col-md-6 col-sm-6">
                    <div class=" course-style-5 bg-white">
                        ...
                        <div class="course-content">
                            ...
                            <div class="course-footer mt-20 d-flex align-items-center justify-content-between">
                                <span class="students"><i class="far fa-user-alt me-2"></i>Annisa Nur Istiqomah</span>
                                <a href="/d_mading" class="rounded-btn"><i class="fa fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="course-item col-lg-3 col-md-6 col-sm-6">
                    <div class=" course-style-5 bg-white">
                        ...
                        <div class="course-content">
                            ...
                            <div class="course-footer mt-20 d-flex align-items-center justify-content-between">
                                <span class="students"><i class="far fa-user-alt me-2"></i>Amelia</span>
                                <a href="/d_mading" class="rounded-btn"><i class="fa fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="course-item col-lg-3 col-md-6 col-sm-6">
                     <div class=" course-style-5 bg-white">
                        ...
                        <div class="course-content">
                            ...
                            <div class="course-footer mt-20 d-flex align-items-center justify-content-between">
                                <span class="students"><i class="far fa-user-alt me-2"></i>Jihan</span>
                                <a href="/d_mading" class="rounded-btn"><i class="fa fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="course-item col-lg-3 col-md-6 col-sm-6">
                    <div class=" course-style-5 bg-white">
                        ...
                        <div class="course-content">
                            ...
                            <div class="course-footer mt-20 d-flex align-items-center justify-content-between">
                                <span class="students"><i class="far fa-user-alt me-2"></i>Karina</span>
                                <a href="/d_mading" class="rounded-btn"><i class="fa fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="course-item col-lg-3 col-md-6 col-sm-6">
                    <div class=" course-style-5 bg-white">
                       ...
                       <div class="course-content">
                           ...
                           <div class="course-footer mt-20 d-flex align-items-center justify-content-between">
                               <span class="students"><i class="far fa-user-alt me-2"></i>Niken Fijriya</span>
                               <a href="/d_mading" class="rounded-btn"><i class="fa fa-long-arrow-right"></i></a>
                           </div>
                       </div>
                   </div>
