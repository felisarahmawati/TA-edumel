                ...
                <div class="course-grid course-style-3">
                    ...
                    <div class="course-content">
                       ...
                       <div class="course-footer mt-20 d-flex align-items-center justify-content-between">
                            ...
                            <a href="{{ url('/user/anggota/tampilan/detail_mading') }}" class="btn btn-main-outline btn-radius btn-sm">Selanjutnya <i class="fa fa-long-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
             </div>
...
<section class="course-category-3 section-padding">
    <div class="container">
        <div class="row mb-70 justify-content-center">
            <div class="col-xl-8">
                <div class="section-heading text-center">
                    <h2 class="font-lg">Semua Kategori Buku</h2>
                    <p>"Ilmu yang sejati seperti barang berharga lainnya, tidak bisa diperoleh
                        dengan mudah. Ia harus diusahakan, dipelajari, dipikirkan, dan lebih dari itu, harus selalu disertai doa"</p>
                </div>
            </div>
            ...
            {{-- <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="/../../assets/user/images/banner/banner-2.jpg" class="d-block w-100" alt="...">
                  </div>
        ...
        <div class="row">
            <div class="col-xl col-lg-4 col-sm-6">
                <div class="single-course-category style-3 bg-4">
                    <div class="course-cat-icon">
                        <img src="/../../assets/user/images/icon/ebook.png" alt="" class="img-fluid">
                    </div>
                    <div class="course-cat-content">
                        <h4 class="course-cat-title">
                            <a href="/d_ebook">Genre Novel</a>
                        </h4>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl col-lg-4 col-sm-6">
                <div class="single-course-category style-3 bg-1">
                    ...
                    <div class="course-cat-content">
                        <h4 class="course-cat-title">
                            <a href="/d_ebook">Teknik Komputer dan Jaringan</a>
                        </h4>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl col-lg-4 col-sm-6">
                <div class="single-course-category style-3 bg-2">
                    ...
                    <div class="course-cat-content">
                        <h4 class="course-cat-title">
                            <a href="/d_ebook">Rekayasa Perangkat Lunak</a>
                        </h4>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-xl-4 col-lg-5">
                           <div class="cta-img mb-4 mb-lg-0">
                               <img src="/../../assets/user/images/blog/book.png" alt="" class="img-fluid">
                           </div>
                        </div>
                        <div class="col-xl-6 col-lg-6">
                            <div class="cta-content ps-lg-4">
                                <span class="subheading mb-10">
                                    Tidak yakin harus mulai dari mana?</span>
                                <h2 class="mb-20">Ingin tahu buku apa saja yang tersedia?</h2>
                                <a href="#" class="btn btn-main rounded"> Buka L-Ebook</a>
                            </div>
                        </div>
                    </div>
                </div>
